        ...
        try {
          ...
          generateQa({ pdfSummary })
            ...
            .catch(qnaError => {
               ...
               toast({
                  title: uiText.qaGenerationFailed,
    ...
    <div className="flex flex-col items-center justify-start min-h-screen p-4 md:p-8 space-y-8 font-body">
      ...
      <AnimatedSection tag="header" className="w-full max-w-4xl text-center">
        <h1 className="text-5xl font-bold font-headline text-primary">
          <Clapperboard className="inline-block h-12 w-12 mr-2 -mt-1 animate-pulse" /> {uiText.mainTitle}
        </h1>
        ...
        <div className="relative container mx-auto px-6 pt-28 pb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-left">
            <div>
              ...
              <p className="text-sm">
                {uiText.footerAnimatePdfDesc}
              </p>
            </div>
            <div>
              <h5 className="font-bold text-lg mb-3 font-headline">{uiText.footerLinksTitle}</h5>
              <ul className="space-y-2">
                {uiText.footerNavLinks.map(link => (
            ...
            <div>
              <h5 className="font-bold text-lg mb-3 font-headline">{uiText.footerFollowTitle}</h5>
          ...
          <p className="text-sm text-center">
            &copy; {new Date().getFullYear()} AnimatePDF. {uiText.footerRights}
            <Sparkles className="inline-block h-4 w-4 mx-1" />
            {uiText.footerPoweredBy}
