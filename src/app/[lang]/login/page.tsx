...
import { LogIn, Clapperboard, Twitter, Linkedin, Github, ArrowRight, Sparkles, Lock, Mail, Eye, EyeOff } from 'lucide-react';
...
const pageUIText = {
  tr: {
    title: "Hoş Geldiniz",
    subtitle: "Hesabınıza giriş yapın ve animasyonlarınıza devam edin",
...
export default function LoginPage({ params: paramsPromise }: LoginPageProps) {
  ...
  const uiText = pageUIText[(currentLang as 'en' | 'tr')] ?? pageUIText.tr;
      ...
      {/* Hero Section */}
          ...
          <Card className="border-0 bg-white shadow-2xl hover:shadow-3xl transition-all duration-500 relative overflow-hidden">
            ...
            <CardHeader className="text-center pb-6 pt-8">
              ...
              <CardTitle className="text-2xl font-bold text-gray-900">Giriş Yapın</CardTitle>
              <CardDescription className="text-gray-600">
                Hesabınıza erişin ve animasyonlarınıza devam edin
              </CardDescription>
          </CardHeader>
