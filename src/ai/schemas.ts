...
export const GenerateSceneImagesInputSchema = z.object({
  scenes: z.array(z.string()).describe('Array of scene descriptions to generate images for.'),
  style: z.string().describe('The visual style for the images (e.g., Fotogerçekçi, Dijital Sanat, Sulu Boya, etc.)'),
});
