...
/**
 * @fileOverview Analyzes a PDF document to extract key themes and points.
 *
 * - analyzePdf - A function that takes PDF content and returns a summary.
 * - AnalyzePdfInput - The input type for the analyzePdf function, a data URI representing the PDF.
 * - AnalyzePdfOutput - The return type for the analyzePdf function, containing the summary.
 */
...
const AnalyzePdfOutputSchema = z.object({
  summary: z.string().describe('A summary of the key themes and points in the PDF document.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert document summarizer.  Please analyze the PDF document provided and generate a concise summary of the key themes and points.  The PDF content is provided as a data URI.
